...
def load_td_data(filename, ev_count=-1, ev_start=0):
    """
    Loads TD prophesee_dlut from files generated by the StreamLogger consumer for Event2D
