...
import os
import numpy as np
import dataloader.prophesee.src.io.dat_events_tools as dat
import dataloader.prophesee.src.io.npy_events_tools as npy_format
...
class PSEELoader(object):
    ...
    def load_delta_t(self, delta_t):
        ...
        batch = 100000
        event_buffer = []
        # prophesee_dlut is read by buffers until enough events are read or until the end of the file
