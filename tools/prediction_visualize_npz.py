...
def parse_args():
    ...
    parser.add_argument(
        '-t', "--td_dir",
        default="E:\\guobiao\\AAAI_Event_based_detection-main\\prophesee_dlut\\train",
        type=str, help="input event files, annotation files are expected to be in the same folder")
    parser.add_argument(
        '-n', "--npy_file", default="E:\\guobiao\\jittor\\save_path\\det_result\\prediction (1).npy", type=str,
